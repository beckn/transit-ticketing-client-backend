...
public class WaybillController {
    ...
    public ResponseEntity<Object> getWaybillReport() {
        ...
        waybillReportDto2.setBoatNumber(2);
        waybillReportDto2.setStartingTime("01:00:00");
        waybillReportDto2.setStartingStage("Trivandrum");
        waybillReportDto2.setEndingStage("Alleppe");
        waybillReportDto2.setEndingTime("02:00:00");
        waybillReportDto2.setStartTicketNumber(1L);
        waybillReportDto2.setEndTicketNumber(10L);
        waybillReportDto2.setTotalIncome(10000L);
        waybillReportDto2.setTotalPassengers(15);
        Routes routes1 = new Routes();
        routes1.setRoute_id(2);
        waybillReportDto2.setRoutes(routes1);
        Trips trips1 = new Trips();
        trips1.setTrip_id(2);
        waybillReportDto2.setTrips(trips1);
